...
const Hero = () => {
    return (
        <section className="hero bg-fixed bg-cover bg-no-repeat pt-[10vh] min-h-screen grid grid-cols-1 md:grid-cols-8 ">
            
            <div className=" md:col-span-5 flex items-center justify-start md:justify-center p-5 md:p-20">
                <div className="flex flex-col gap-8 ">
                    <h1 className="md:text-8xl  text-[5.5rem] font-medium tracking-wide leading-[7rem]  ">
