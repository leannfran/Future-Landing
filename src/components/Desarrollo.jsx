...
const Desarrollo = () => {
  ...
  return (
    <>
      ...
      <div
        id="myElement"
        className={`${animacion ? "animate-fade animate-ease-in-out animate-normal animate-fill-forwards opacity-100" : "opacity-0"} flex gap-8 flex-col md:flex-row mx-3 md:mx-20 mt-20 myElement`}
      >
      ...
      <div
        id="myElement"
        className={`${animacion ? "animate-fade animate-ease-in-out animate-normal animate-fill-forwards opacity-100" : "opacity-0"} flex flex-col md:flex-row gap-8 md:items-end mx-3 md:mx-20 mt-14  myElement`}
      >
        <img
      ...
      <div
        id="myElement3"
        className="flex gap-8 flex-col md:flex-row my-5 mx-3 md:mx-20 mt-20 myElement"
      >
        <div className="flex flex-col md:w-1/2">
          <h4 className="text-3xl custom-shadow-hover transition-all  font-black">
            THIRD STEP
      ...
      <div
        id="myElement4"
        className="flex flex-col md:flex-row gap-8 md:items-end mx-3 md:mx-20 mt-14 myElement"
      >
        <img
          className=" md:mx-20 md:w-1/3 my-5 hidden md:block"
        ...
        <div className="flex flex-col md:w-1/2">
          ...
          <p className="text-xl text-left font-light text-gray-900 pb-5">
            Antes de presentar tu proyecto al mundo, nos tomamos el tiempo
            necesario para realizar rigurosas pruebas de hospedaje y
            rendimiento. Queremos garantizar que tu sitio web o aplicación estén
            optimizados, seguros y funcionen sin problemas. Tu satisfacción y el
            éxito de tu proyecto son nuestra prioridad absoluta.
          </p>
        </div>
        <img
          className=" md:mx-20 md:w-1/3 my-5 md:hidden"
      ...
      <div
        id="myElement5"
        className="flex gap-8 flex-col md:flex-row mx-3 md:mx-20 mt-20 myElement"
      >
        <div className="flex flex-col md:w-1/2">
          <h4 className="text-3xl custom-shadow-hover transition-all  font-black">
            FIFTH STEP
          ...
          <p className="text-xl font-light text-gray-900">
            Una vez que todo esté listo, nos aseguramos de que tu proyecto
            llegue a las personas adecuadas. Utilizamos estrategias efectivas de
            posicionamiento en buscadores (SEO) para mejorar la visibilidad en
            línea. Además, podemos ayudarte a crear campañas publicitarias
            impactantes que lleguen directamente a tu audiencia objetivo.
            Queremos que tu proyecto brille en el panorama digital. Estamos
            emocionados de embarcarnos en este viaje contigo y ayudarte a
            alcanzar tus objetivos. Si tienes alguna otra pregunta o necesitas
            más ayuda, ¡no dudes en decírmelo!
          </p>
        </div>
        <img
          className="md:ml-20 md:w-1/3 my-5 "
